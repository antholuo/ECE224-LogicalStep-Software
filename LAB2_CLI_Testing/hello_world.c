    ...
    for (;;)
    {
        ...
        case 'f': /* FatFS API controls */
            ...
            case 'p': /* fp <len> - read and play file from current fp */
                ...
                uint8_t playback_buf[BUF_SIZE] __attribute__((aligned(4))); // attribute aligned

                int io_switches = (0b11 & IORD(SWITCH_PIO_BASE, 0x0));
